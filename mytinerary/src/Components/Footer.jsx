    ...
    return (
        <footer className="bg-gray-800 text-white py-8">
            <div className="container mx-auto flex justify-between items-center flex-wrap">
                ...
                <div className="w-full md:w-1/3 text-center md:text-left mb-6 md:mb-0">
                    ...
                    <p className="text-sm mt-2">
                        Explora el mundo a través de itinerarios detallados y personalizados.
                    </p>
                    <p className="text-sm mt-2">Dirección: Calle 123, Ciudad, País</p>
                ...
                <div className="w-full md:w-1/3 text-center mb-6 md:mb-0">
                    ...
                    <ul className="mt-4 space-y-2">
                        <li>
                            <NavLink to="/" className="text-gray-400 hover:text-white">Inicio</NavLink>
                        </li>
                        <li>
                            <NavLink to="/about" className="text-gray-400 hover:text-white">Sobre Nosotros</NavLink>
                        </li>
                        <li>
                            <NavLink to="/tineraries" className="text-gray-400 hover:text-white">Itinerarios</NavLink>
                        </li>
                        <li>
                            <NavLink to="/contact" className="text-gray-400 hover:text-white">Contacto</NavLink>
                        </li>
                    </ul>
                </div>
            ...
            <div className="text-center text-sm text-gray-500 mt-6">
                © 2024 My Tineraries - Todos los derechos reservados
            </div>
        </footer>
    );
}
